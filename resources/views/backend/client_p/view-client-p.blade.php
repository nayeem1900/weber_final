                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>About List
                                    ...
                                    <a class="btn btn-success float-right btn-sm" href="{{route('clogos.add')}}"><i class="fa fa-plus-circle"></i> Add Client Picture</a>
                                    ...
                                    @foreach($allData as $key=>$value)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a title="Edit" class="btn btn-sm btn-primary" href="{{route('clogos.edit',$value->id)}}"><i class="fa fa-edit"></i></a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{route('clogos.delete',$value->id)}}" method="post">
                                                                    @csrf
