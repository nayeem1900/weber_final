                            ...
                            <div class="card-body" >
                                ...
                                <form method="POST" action="{{route('etenders.update',$editData->id)}}"enctype="multipart/form-data" >
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <img id="showImage" src="{{(!empty($editData->t_download))?url('public/upload/etender_images/'.$editData->t_download):url('public/upload/no_img.png')}}" style="width:150px;height:160px;border:1px solid#000;">
                                    </div>
